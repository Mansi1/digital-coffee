    ...
    <div className="my-6">
      ...
      <div className="flex justify-center gap-4 mb-8">
        {[...Array(length)].map((_, i) => (
          <div
            key={i}
            className={cn(`w-4 h-4 rounded-full transition-all duration-200`, {
              'bg-primary-300 scale-110': pin.length > i,
      ...
      <Button className="mt-4" disabled={pin.length < length} onClick={() => onComplete(pin)}>
